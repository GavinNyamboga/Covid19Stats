...
public class CountriesResources {
    ...
    public CountriesResources() {

    }

    public CountriesResources(String country, CountriesInfo countryInfo, Integer cases,Integer todayDeaths, Integer todayCases, Integer deaths, Integer recovered, Integer active, Integer critical, double casesPerOneMillion, double deathsPerOneMillion, double updated) {
